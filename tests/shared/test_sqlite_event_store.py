...
class TestSqliteEventStore:
    ...
    def test_append_and_load_single_event(self, event_store: SqliteEventStore) -> None:
        ...
        event = SampleEvent(campaign_id=campaign_id, value="test")
    ...
    def test_append_multiple_events_preserves_order(
        ...
        event_store.append(campaign_id, SampleEvent(campaign_id=campaign_id, value="first"))
        event_store.append(campaign_id, SampleEvent(campaign_id=campaign_id, value="second"))
        event_store.append(campaign_id, SampleEvent(campaign_id=campaign_id, value="third"))
    ...
    def test_campaign_isolation(self, event_store: SqliteEventStore) -> None:
        ...
        event_store.append(campaign_1, SampleEvent(campaign_id=campaign_1, value="campaign1"))
        event_store.append(campaign_2, SampleEvent(campaign_id=campaign_2, value="campaign2"))
        ...
        assert isinstance(events_1[0], SampleEvent)
        assert isinstance(events_2[0], SampleEvent)
    ...
    def test_append_only_constraint(self, event_store: SqliteEventStore) -> None:
        ...
        campaign_id = str(uuid4())
        event1 = SampleEvent(campaign_id=campaign_id, value="first")

        event_store.append(campaign_id, event1)
        events_before = event_store.load(campaign_id)

        # Append another event
        event2 = SampleEvent(campaign_id=campaign_id, value="second")
        ...
        assert isinstance(events_after[0], SampleEvent)
